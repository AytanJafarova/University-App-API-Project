    ...
    public partial class intiial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PreExamId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ...
                    Midterm = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PreExams", x => x.PreExamId);
                    table.ForeignKey(
                        name: "FK_PreExams_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PreExams_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Grades_PreExams_PreExamId",
                        column: x => x.PreExamId,
                        principalTable: "PreExams",
                        principalColumn: "PreExamId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Status",
                columns: new[] { "StatusId", "Key", "StatusName" },
                values: new object[,]
                {
                    { 1, "admin", "ADMIN" },
                    { 2, "teacher", "TEACHER" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PreExams_CourseId",
                table: "PreExams",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_PreExams_StudentId",
                table: "PreExams",
                column: "StudentId");
